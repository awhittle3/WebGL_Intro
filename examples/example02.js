...
function main() {
    ...
    const fsSource =
        ...
        void main() {
            fragColor = vec4(0.18039, 0.29019, 0.41176, 1.0);
        }
        `;
    ...
    var buffers = initTriangleBuffer(gl, programInfo);
...
function drawScene(gl, deltaTime, programInfo, buffers) {
    ...
    {
        // Choose to use the appropriate buffers
        gl.bindBuffer(gl.ARRAY_BUFFER, buffers.positionBuffer);

        // Draw the object
        const offset = 0; // Number of elements to skip before starting
        const vertexCount = buffers.position.numVertices; // Number of vertices to draw
 ...
 */
function initTriangleBuffer(gl, programInfo) {
    ...
    gl.bufferData(
        ...
        positions, // The data in an Array object
    ...
    // buffer into the vertexPosition attribute.
    {
        ...
        // Choose what buffer we want to load our data into
        gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    ...
    return {
        position: {
            VBO: positionBuffer, // This is our vertex buffer object
            numVertices: 3 // There are 3 vertices in our object
        }
    };
}